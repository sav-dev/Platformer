...
CONST_ENEMY_EXPL_POINTER  = $02 + CONST_ENEMY_RENDER_INFO ; render info is two bytes
CONST_ENEMY_EXPL_OFF      = $01 + CONST_ENEMY_EXPL_POINTER
CONST_ENEMY_LAST          = $02 + CONST_ENEMY_EXPL_OFF ; expl_off is two bytes

AFTER_LAST_ENEMY          = ENEMIES_TOTAL_SIZE
