...
NUMBER_OF_LEVELS_STAGE_3 = $0A
  ...
  ; stage 4
NUMBER_OF_LEVELS_STAGE_4 = $0D
  .byte $00, LOW(storyStage4), HIGH(storyStage4)
  .byte $05, LOW(level_4_01), HIGH(level_4_01)
  .byte $06, LOW(level_4_02), HIGH(level_4_02)
  .byte $00, LOW(level_4_03), HIGH(level_4_03)
  .byte $00, LOW(level_4_04), HIGH(level_4_04)
  .byte $05, LOW(level_4_05), HIGH(level_4_05)
  .byte $00, LOW(level_4_06), HIGH(level_4_06)
  .byte $06, LOW(level_4_07), HIGH(level_4_07)
  .byte $00, LOW(level_4_08), HIGH(level_4_08)
  .byte $06, LOW(level_4_09), HIGH(level_4_09)
